	...
	_createClass(Lightbox, [{
		...
		value: function renderVideo(image) {
			...
			return _react2.default.createElement(
				'div',
				{
					className: (0, _aphrodite.css)(this.classes.videoContainer),
					style: {
						width: 'calc((100vh - ' + heightOffset + ') * 16 / 9)'
					}
				},
				_react2.default.createElement('div', { className: (0, _aphrodite.css)(this.classes.videoDummyElement) }),
				_react2.default.createElement('iframe', {
					className: (0, _aphrodite.css)(this.classes.video, imageLoaded && this.classes.videoLoaded),
...
Lightbox.propTypes = {
	...
	images: _propTypes2.default.arrayOf(_propTypes2.default.shape({
		...
		youtubeVideoId: _propTypes2.default.string,
